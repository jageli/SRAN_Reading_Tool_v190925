...
import SRAN_mod.EQM
import SRAN_mod.EQM_R
import SRAN_mod.INVUNIT_R
import SRAN_mod.LTE_BTS
import SRAN_mod.MNL
import SRAN_mod.MRBTS
import SRAN_mod.SRAN_GNBTS
import SRAN_mod.SRAN_HW
import SRAN_mod.TNL
import SRAN_mod.GSM_18A

# from mod import *
# import os
# import sys
# current_folder=os.getcwd()
# LIBFOLDER = current_folder + "\SRAN_mod"
...
def del_all(self,checkbox_name):
    ...
    if reply == QMessageBox.Yes:
        ...
        DSN = 'PROVIDER = Microsoft.Jet.OLEDB.4.0;DATA SOURCE = SRAN.mdb'
        conn.Open(DSN)
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # ## # # # # # # # # # # # # # # # # # # # # # # # #
 ...
 # # # # # # # # # # # # # # MRBTS # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    ...
    if node.attrib["class"] == "MRBTS" and checkbox_state[checkbox_name.index("MRBTS")] == 1:
        SRAN_mod.MRBTS.MRBTS(node, NODE_LIST)
...
# # # # # # # # # # # # # # GSM # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    ...
    if node.attrib["class"] == "UNIT" and checkbox_state[checkbox_name.index("UNIT")] == 1:
        SRAN_mod.GSM_18A.UNIT(node, NODE_LIST)
    # 读取GSM_HW到list
    if node.attrib["class"] == "HW" and checkbox_state[checkbox_name.index("HW_GSM")] == 1:
        SRAN_mod.GSM_18A.HW_GSM(node, NODE_LIST)
